 ...
 */
router.get('/api/v1/swagger.json',(_req,res)=>{
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/glossary', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/marketStatus', async (_req, res) => {
    try {
        res.json(await nseIndia.getDataByEndpoint(ApiList.MARKET_STATUS))
    } catch (error) {
        res.status(400).json(error)
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/marketTurnover', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equityMaster', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/mergedDailyReports', async (req, res) => {
    try {
        const { key } = req.query
        if (key === 'debt') {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/allIndices', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/indexNames', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/allSymbols', async (_req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/series/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/tradeInfo/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/corporateInfo/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/intraday/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/equity/historical/:symbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/index/:indexSymbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/index/intraday/:indexSymbol', async (req, res) => {
    try {
        const isPreOpen = req.query.preOpen as string
        if (isPreOpen === "true") {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/index/historical/:indexSymbol', async (req, res) => {
    try {
        const dateStart = req.query.dateStart as string
        const dateEnd = req.query.dateEnd as string
        if (dateStart && dateEnd) {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/gainersAndLosers/:indexSymbol', async (req, res) => {
    try {
 ...
 *         description: Returns a JSON error object of API call
 */
router.get('/api/mostActive/:indexSymbol', async (req, res) => {
    try {
